...
Sound_4 = pygame.mixer.Sound("hit.wav")
# Sound_4.set_volume(1)
Sound_1 = pygame.mixer.Sound("background_song.wav")
Sound_1.set_volume(0)
# Sound_3 = pygame.mixer.Sound("")
# Sound_5 = pygame.mixer.Sound("")
grey=(118,119,110)	#colour code in RBG form
black=(0,0,0)		#colour code in RBG form
display=pygame.display.set_mode((824,600))		#set width & height of display
...
def crash():		#create crash function to display this message
	message_display("Game Over")	#display this message call the message_display function
#---------------------------------------------------------------------------------------------------------------------------------------------#
def message_display(text):		#create function for message edit
	...
	textrect.center=((425),(300))	#show the message position in display
...
#---------------------------------------------------------------------------------------------------------------------------------------------#
def message_display1(text):		#create function for message edit
	largetext=pygame.font.Font("freesansbold.ttf",40)	#message in this style and the size will be 80
	textsurf,textrect=text_object(text,largetext)	#create function to edit message
	textrect.center=((425),(50))	#show the message position in display
	display.blit(textsurf,textrect)	#display this message
	pygame.display.update()	#update display
...
def loop():		#all the function are called using this function
	...
	while not bumped:	#game is start
		...
		message_display1(f"Score : {score}")
